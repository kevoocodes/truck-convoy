...
<!-- Mirrored from dashui.codescandy.com/dashuipro/pages/dashboard-ecommerce.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Nov 2023 16:56:04 GMT -->
<head>
  <!-- Required meta tags -->
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
<meta name="author" content="kevoocodes">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><a href="#!" class="text-inherit">
                              <img src="{{ asset('assets/images/avatar/avatar-8.jpg')}}" alt="Image"
                        ...
                        <tr>
                          ...
                          <td><a href="#!" class="text-inherit">
                              <img src="{{ asset('assets/images/avatar/avatar-11.jpg')}}" alt="Image"
                                class="avatar-xs avatar rounded-circle me-1">
                        ...
                        <tr>
                          ...
                          <td><a href="#!" class="text-inherit">
                              <img src="{{ asset('assets/images/avatar/avatar-2.jpg')}}" alt="Image"
                                class="avatar-xs avatar rounded-circle me-1">
                        ...
                        <tr>
                          ...
                          <td><a href="#!" class="text-inherit">
                              <img src="{{ asset('assets/images/avatar/avatar-3.jpg')}}" alt="Image"
                                class="avatar-xs avatar rounded-circle me-1">
                        ...
                        <tr>
                          ...
                          <td><a href="#!" class="text-inherit">
                              <img src="{{ asset('assets/images/avatar/avatar-4.jpg')}}" alt="Image"
                                class="avatar-xs avatar rounded-circle me-1">
                    ...
                    <table class="table text-nowrap mb-0 table-centered">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <div class=" d-flex">
                              <a href="#!"> <img src="{{ asset('assets/images/svg/brand-logo-1.svg')}}" alt="Image"></a>
                              <div class="ms-3 lh-1">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class=" d-flex">
                              <a href="#!"> <img src="{{ asset('assets/images/svg/brand-logo-2.svg')}}" alt="Image"></a>
                              <div class="ms-3 lh-1">
                        ...
                        <tr>
                          <td>
                            <div class=" d-flex">
                              <a href="#!"> <img src="{{ asset('assets/images/svg/brand-logo-3.svg')}}" alt="Image"></a>
                              <div class="ms-3 lh-1">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class=" d-flex">
                              <a href="#!"> <img src="{{ asset('assets/images/svg/brand-logo-4.svg')}}" alt="Image"></a>
                              <div class="ms-3 lh-1">
                        ...
                        <tr>
                          <td>
                            <div class=" d-flex">
                              <a href="#!"> <img src="{{ asset('assets/images/svg/brand-logo-5.svg')}}" alt="Image"></a>
                              <div class="ms-3 lh-1">
                        ...
                        <tr>
                          <td>
                            <div class=" d-flex">
                              <a href="#!"> <img src="{{ asset('assets/images/svg/brand-logo-6.svg')}}" alt="Image"></a>
                              <div class="ms-3 lh-1">
...
<!-- Mirrored from dashui.codescandy.com/dashuipro/pages/dashboard-ecommerce.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Nov 2023 16:56:12 GMT -->
</html>